...
Gaby, la perspicaz detective del corazón, ha llegado al umbral. Todo parece suspendido en un ensueño: su novio Wylli, un brillante investigador de ciberseguridad, ha caído en un profundo letargo frente a sus monitores luminosos tras semanas de silenciosa preparación.
...
Para romper el sortilegio y revelar el gran misterio que él juró develar este 21 de septiembre, Gaby debe recorrer las estancias de la cabaña, investigar los indicios forenses y desentrañar tres enigmas cifrados paso a paso. El leal Oficial John Nolan (LAPD) vigila el perímetro y la asistirá por radio con pistas graduales...`,
  ...
  },
  {
    ...
    prose: `Frente al fuego crepitante de la chimenea de piedra, una pequeña tacita de porcelana despide espirales de vapor tibio junto a Wylli, que descansa en el sofá verde con su gorra blanca de tiburón. Sobre una servilleta de lino, Wylli escribió a mano un misterioso mensaje cifrado:
...
Una nota de ciberseguridad al pie susurra: —"Aquel que cifra sus sentimientos busca que solo tú, dueña de su sol matutino, recuerdes las tres letras de desplazamiento (ROT-3) que iluminan cada despertar..."`,
  ...
  },
  {
    ...
    prose: `En la serenidad de la suite, un gatito blanco como la nieve de cumbre duerme ovillado sobre un cojín de terciopelo añil. Su respiración acompasada custodia un secreto dejado por Wylli.

Bajo una de sus suaves patitas, resalta un naipe de baraja: el As de Corazones (♥ A). Wylli le aplicó esteganografía forense: al pasarle luz ultravioleta, una filigrana dorada revela estrellas conectadas y el texto:
...
«En la inmensidad del cielo nocturno, tú eres el mapa de estrellas que guía cada uno de mis pasos... M_ C___________N»`,
  ...
  },
  {
    ...
    prose: `El vapor sisea suavemente en la cafetera de espresso de cobre y latón en la cocina. Sobre la pizarra de notas, Wylli programó la fórmula alquímica del antídoto:

«SCRIPT: wake_boyfriend.sh --mode D____ D________»

El aroma a granos tostados de especialidad y canela de Ceilán inunda la cocina. Para preparar el legendario Café Supremo y despertar a Wylli, Gaby debe deducir la frase del amanecer más dulce.`,
  ...
  },
  {
    ...
    prose: `Con los tres sellos descifrados y el Café Supremo servido con infinita ternura, los párpados de Wylli se abren despacio. Su mirada se llena de alegría al ver a Gaby victoriosa frente a él.

—Sabía que tu ingenio y tu corazón encontrarían cada una de mis huellas, amor —susurra Wylli con una sonrisa conmovida—. Toma esta carta lacrada con cera escarlata. Ven conmigo al mirador secreto de la montaña; lo que está escrito allí florecerá para ti en todo el valle...
...
En ese instante, la brisa de la montaña disipa la densa bruma exterior, abriendo paso al escenario de las flores amarillas del 21 de septiembre.`,
    clueHint: 'Despierta a Wylli con el Café Supremo y acompáñalo al Jardín Secreto de las Flores Amarillas.',
    solved: false,
    requiredFlag: 'all',
...
export const HOTSPOT_DIALOGUES: Record<string, StoryDialogue> = {
  ...
  cinnamonTea: {
    speaker: 'narrator',
    speakerName: 'Mesa de Té & Servilleta de Wylli',
    avatar: '📜',
  ...
  espresso: {
    speaker: 'narrator',
    speakerName: 'Alquimia Barista de Wylli',
    avatar: '☕',
    atmosphere: 'El cobre de la cafetera resplandece bajo las luces cálidas de la barra...',
    text: '«La máquina de espresso mantiene la presión óptima de extracción. En la libreta de recetas, Wylli dejó escrito: <code>«wake_boyfriend.sh --mode D____ D________»</code>. Deduce la frase del amanecer más dulce para calibrar la molienda.»',
  },
  nolan: {
    speaker: 'nolan',
    ...
    text: '«—Detective Gaby, recuerde: en la policía de Los Ángeles resolvemos los casos analizando los patrones y las emociones de quien dejó las pistas. Wylli la ama profundamente; cada código es una carta de amor encriptada. ¡Confíe en su instinto o pídame una pista por radio en cualquier momento!»',
  },
  novio: {
    speaker: 'novio',
    speakerName: 'Wylli (Ciberinvestigador)',
    avatar: '💻',
    atmosphere: 'Las líneas de código verde esmeralda descienden rítmicamente en sus pantallas...',
    text: '«Wylli duerme con su gorra blanca de tiburón y auriculares al cuello. En su portátil brilla: <code>[STATUS: LOCKDOWN ENCRYPTED]</code>. Una nota adhesiva dice: "Gaby amor, cuando descifres mis 3 banderas en tu libreta, prepárame el Café Supremo y romperás el bloqueo".»',
  },
};
...
export const PROLOGUE_STEPS: PrologueStep[] = [
  {
    ...
    dialogue: 'He llegado a la Cabaña de los Tres Suspiros. Hoy es 21 de septiembre, una fecha que Wylli y yo marcamos en el calendario con tanto anhelo. El aroma a leña de cedro y canela inunda el porche... pero el silencio que sale del interior es extraño.',
  ...
  },
  {
    ...
    dialogue: '—Central de Policía LAPD, ¿cuál es su emergencia? —¡Operadora! Soy Gaby, estoy en la cabaña del risco y mi novio investigador no despierta; hay notas cifradas y candados digitales en la sala. —Tranquila, señorita Gaby. Tenemos una patrulla en la zona. Le enviamos de inmediato a nuestro oficial más noble y perspicaz: el Oficial John Nolan.',
  ...
  },
  {
    ...
    dialogue: '—Estaré vigilando desde el gazebo y el bosque. Llévese este radiotransmisor en la frecuencia táctica. Cuando se acerque a un objeto o necesite deducir, llámeme por el Canal 7. Le daré pistas cortas y progresivas para que no se sature. ¡Encontremos esos 3 sellos y despertemos a Wylli!',
...
export const NOLAN_RADIO_ADVICES: Record<'flag1' | 'flag2' | 'flag3' | 'allSolved', NolanAdviceItem> = {
  flag1: {
    ...
    brief: 'Sobre la mesita baja junto a Wylli hay una servilleta escrita: «Vrv pl vro» (ROT-3).',
    steps: [
      {
        speaker: 'Oficial John Nolan',
        badge: 'Procedimiento de Campo',
        text: '10-4, Detective Gaby. Primero lo primero: acérquese a la sala e inspeccione la mesita de café junto a Wylli. Una buena detective nunca deduce sin recoger la evidencia física con sus propios ojos.',
      },
      {
        speaker: 'Oficial John Nolan',
    ...
    connectingQuestion: '¿Qué método criptográfico empleó Wylli y hacia dónde debemos rotar el dial?',
    quickOptions: [
  ...
  flag2: {
    ...
    steps: [
      ...
      },
      {
        ...
        text: 'A simple vista es un As de Corazones común. Pero Wylli aplicó esteganografía con tinta invisible. Debe encender la linterna ultravioleta (365nm) para que las estrellas doradas ocultas brillen en la oscuridad.',
      },
      {
        speaker: 'Oficial John Nolan',
        badge: 'Guía de Deducción',
  ...
  flag3: {
    ...
    steps: [
      {
        speaker: 'Oficial John Nolan',
        badge: 'Procedimiento de Campo',
        text: '10-4, Detective Gaby. El tercer enigma está en la cocina. Acérquese a la máquina barista de cobre y examine la pizarra donde Wylli programó la terminal.',
      },
      {
        speaker: 'Oficial John Nolan',
    ...
    connectingQuestion: '¿Qué dos conceptos forman el modo matutino para despertar a Wylli?',
    quickOptions: [
      ...
      { text: 'Café instantáneo con agua helada', correct: false, response: 'Wylli es un barista meticuloso, ¡requiere espresso doble calibrado!' },
  ...
  allSolved: {
    ...
    steps: [
      ...
      },
      {
        speaker: 'Oficial John Nolan',
        badge: 'Paso Final',
        text: 'Lleve la taza de Café Supremo humeante con canela hasta los sofás verdes. ¡El aroma despertará a Wylli!',
      },
      {
        speaker: 'Oficial John Nolan',
        badge: 'La Sorpresa',
        text: 'Wylli la está esperando para revelarle la sorpresa más hermosa del 21 de septiembre.',
      },
    ],
    connectingQuestion: '¡Es hora de despertar a Wylli con el Café Supremo!',
    quickOptions: [],
    toolTarget: 'barista',
